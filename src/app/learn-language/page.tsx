...
> = {
  ...
  en: {
    ...
    chooseDescription:
      "Start with a language you would like to explore. Learn useful words, phrases, pronunciation and cultural expressions.",
  ...
  hi: {
    ...
    chooseDescription:
      "उस भाषा से शुरुआत करें जिसे आप सीखना चाहते हैं। शब्द, वाक्य, उच्चारण और सांस्कृतिक अभिव्यक्तियाँ सीखें।",
    ...
    footerDescription:
      "भारतीय खेलों की विरासत को फिर से खोजें",
  ...
  ta: {
    ...
    eyebrow:
      "மொழி • கலாச்சாரம் • இணைப்பு",

    title:
      "பாரம்பரியத்தின் மூலம் ஒரு மொழியைக் கற்றுக்கொள்ளுங்கள்",
    ...
    chooseDescription:
      "நீங்கள் கற்க விரும்பும் மொழியுடன் தொடங்குங்கள். சொற்கள், வாக்கியங்கள், உச்சரிப்பு மற்றும் கலாச்சார வெளிப்பாடுகளைக் கற்றுக்கொள்ளுங்கள்.",
    ...
    howTitle:
      "கற்கவும். கேட்கவும். பயிற்சி செய்யவும்.",
  ...
  te: {
    ...
    eyebrow:
      "భాష • సంస్కృతి • అనుసంధానం",

    title:
      "వారసత్వం ద్వారా భాషను నేర్చుకోండి",
    ...
    chooseDescription:
      "మీరు నేర్చుకోవాలనుకునే భాషతో ప్రారంభించండి. పదాలు, వాక్యాలు, ఉచ్చారణ మరియు సాంస్కృతిక వ్యక్తీకరణలను నేర్చుకోండి.",
    ...
    howTitle:
      "నేర్చుకోండి. వినండి. అభ్యసించండి.",
  ...
  kn: {
    ...
    eyebrow:
      "ಭಾಷೆ • ಸಂಸ್ಕೃತಿ • ಸಂಪರ್ಕ",

    title:
      "ಪರಂಪರೆಯ ಮೂಲಕ ಭಾಷೆಯನ್ನು ಕಲಿಯಿರಿ",
    ...
    chooseDescription:
      "ನೀವು ಕಲಿಯಲು ಬಯಸುವ ಭಾಷೆಯೊಂದಿಗೆ ಪ್ರಾರಂಭಿಸಿ. ಪದಗಳು, ವಾಕ್ಯಗಳು, ಉಚ್ಚಾರಣೆ ಮತ್ತು ಸಾಂಸ್ಕೃತಿಕ ಅಭಿವ್ಯಕ್ತಿಗಳನ್ನು ಕಲಿಯಿರಿ.",
